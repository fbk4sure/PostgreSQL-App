...
Database.initialise(user='postgres', password='Winter2020', host='localhost', database='learning')
...
tweets = user.twitter_request('https://api.twitter.com/1.1/search/tweets.json?q=Machine Learning+filter:images')
